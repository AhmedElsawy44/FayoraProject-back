...
public class ReviewCreatedEventHandler(
    ...
    IUnitOfWork unitOfWork) : INotificationHandler<ReviewCreatedEvent>
{
    public async Task Handle(ReviewCreatedEvent notification, CancellationToken cancellationToken)
    {
        switch (notification.TargetType)
        {
            case ReviewTargetType.TourGuide:
                ...
                {
                    guide.AddReview(notification.Rating);
                }
                break;
            ...
            case ReviewTargetType.GuidePackage:
                ...
                {
                    package.AddReview(notification.Rating);
                }
                break;
            ...
            case ReviewTargetType.HousingUnit:
                ...
                if (unit is not null)
                {
                    unit.AddReview(notification.Rating);
                }
                break;
        }
