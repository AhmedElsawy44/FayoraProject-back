        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "int", nullable: false),
                    IsListingEnabled = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DepartureLatitude = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: false),
                    DepartureLongitude = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompanyTourPackages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CompanyTourPackages_TourCompanies_CompanyId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompanyTourPackageImages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CompanyTourPackageImages_CompanyTourPackages_PackageId",
                        column: x => x.PackageId,
                        principalTable: "CompanyTourPackages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PackageActivities_CompanyTourPackages_PackageId",
                        column: x => x.PackageId,
                        principalTable: "CompanyTourPackages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyTourPackageImages_PackageId",
                table: "CompanyTourPackageImages",
                column: "PackageId");

            migrationBuilder.CreateIndex(
                name: "IX_CompanyTourPackages_CompanyId",
                table: "CompanyTourPackages",
                column: "CompanyId");
